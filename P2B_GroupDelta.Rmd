...
author: "Sameena,Shravan Kumar Bittla,Satish Penumarthi"
...
# ggplot(as.data.frame(m), aes(x=x[, 1],y=x[, 2]))+geom_point(colour="white", shape=21, size = 4,aes(fill = factor(v)))+scale_fill_manual(Values = colors[1:21])
# ggplot(as.data.frame(m), aes(x=x[, 1],y=x[, 2]))+geom_point(colour="white", shape=21, size = 4,aes(fill = factor(v)))+scale_fill_gradient(low = "#771C19", hi = "#000000")
```
